...
func init() {
	ptr0 := &system.Base{Description: "Automatically created basic rule for icon", Id: system.Reference{Package: "github.com/dave/ke_common/images", Name: "@icon", Exists: true}, Rules: []system.Rule(nil), Type: system.Reference{Package: "kego.io/system", Name: "type", Exists: true}}
	...
	ptr2 := &system.Base{Description: "Restriction rules for images", Id: system.Reference{Package: "github.com/dave/ke_common/images", Name: "@image", Exists: true}, Rules: []system.Rule(nil), Type: system.Reference{Package: "kego.io/system", Name: "type", Exists: true}}
	...
	ptr7 := &system.Base{Description: "Automatically created basic rule for photo", Id: system.Reference{Package: "github.com/dave/ke_common/images", Name: "@photo", Exists: true}, Rules: []system.Rule(nil), Type: system.Reference{Package: "kego.io/system", Name: "type", Exists: true}}
	...
	ptr9 := &system.Base{Description: "This is a type of image, which just contains the url of the image", Id: system.Reference{Package: "github.com/dave/ke_common/images", Name: "icon", Exists: true}, Rules: []system.Rule(nil), Type: system.Reference{Package: "kego.io/system", Name: "type", Exists: true}}
	...
	ptr13 := &system.Type{Base: ptr9, Embed: []system.Reference(nil), Fields: map[string]system.Rule{"url": ptr12}, Is: []system.Reference{system.Reference{Package: "github.com/dave/ke_common/images", Name: "image", Exists: true}}, Native: system.String{Value: "object", Exists: true}, Rule: (*system.Type)(nil)}
	ptr14 := &system.Base{Description: "This interface type represents all images - icon and photo", Id: system.Reference{Package: "github.com/dave/ke_common/images", Name: "image", Exists: true}, Rules: []system.Rule(nil), Type: system.Reference{Package: "kego.io/system", Name: "type", Exists: true}}
	...
	ptr16 := &system.Base{Description: "This represents an image, and contains path, server and protocol separately", Id: system.Reference{Package: "github.com/dave/ke_common/images", Name: "photo", Exists: true}, Rules: []system.Rule(nil), Type: system.Reference{Package: "kego.io/system", Name: "type", Exists: true}}
	...
	ptr26 := &system.Base{Id: system.Reference{}, Rules: []system.Rule(nil), Type: system.Reference{Package: "github.com/dave/ke_common/units", Name: "@rectangle", Exists: true}}
	ptr27 := &system.RuleBase{}
	ptr28 := &units.Rectangle_rule{Base: ptr26, RuleBase: ptr27}
	ptr29 := &system.Type{Base: ptr16, Embed: []system.Reference(nil), Fields: map[string]system.Rule{"path": ptr19, "protocol": ptr22, "server": ptr25, "size": ptr28}, Is: []system.Reference{system.Reference{Package: "github.com/dave/ke_common/images", Name: "image", Exists: true}}, Native: system.String{Value: "object", Exists: true}, Rule: (*system.Type)(nil)}
	system.RegisterType("github.com/dave/ke_common/images", "@icon", ptr1, 0x31466dcde3ac4844)
	system.RegisterType("github.com/dave/ke_common/images", "@image", ptr6, 0xa3f1010f55717184)
	system.RegisterType("github.com/dave/ke_common/images", "@photo", ptr8, 0xd19da332549fd941)
	system.RegisterType("github.com/dave/ke_common/images", "icon", ptr13, 0x31466dcde3ac4844)
	system.RegisterType("github.com/dave/ke_common/images", "image", ptr15, 0xa3f1010f55717184)
	system.RegisterType("github.com/dave/ke_common/images", "photo", ptr29, 0xd19da332549fd941)
}
