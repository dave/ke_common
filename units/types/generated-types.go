...
func init() {
	ptr0 := &system.Base{Description: "Automatically created basic rule for rectangle", Id: system.Reference{Package: "github.com/dave/ke_common/units", Name: "@rectangle", Exists: true}, Rules: []system.Rule(nil), Type: system.Reference{Package: "kego.io/system", Name: "type", Exists: true}}
	...
	ptr2 := &system.Base{Id: system.Reference{Package: "github.com/dave/ke_common/units", Name: "rectangle", Exists: true}, Rules: []system.Rule(nil), Type: system.Reference{Package: "kego.io/system", Name: "type", Exists: true}}
	...
	system.RegisterType("github.com/dave/ke_common/units", "@rectangle", ptr1, 0x1dec0b16d337111a)
	system.RegisterType("github.com/dave/ke_common/units", "rectangle", ptr9, 0x1dec0b16d337111a)
}
